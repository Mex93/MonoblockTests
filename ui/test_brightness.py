...
################################################################################
## Form generated from reading UI file 'test_brightness.ui'
##
...
class Ui_TestBrightnessWindow(object):
...
"padding: 20%;")
        ...
        self.retranslateUi(TestBrightnessWindow)

        QMetaObject.connectSlotsByName(TestBrightnessWindow)
    # setupUi
