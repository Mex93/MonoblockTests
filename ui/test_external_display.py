...
class Ui_TestExternalDisplayWindow(object):
    def setupUi(self, TestExternalDisplayWindow):
        ...
        self.videobox = QVideoWidget(self.groupBox)
        self.videobox.setObjectName(u"videobox")

        self.horizontalLayout_2.addWidget(self.videobox)
...
"padding: 20%;")
        ...
        TestExternalDisplayWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(TestExternalDisplayWindow)

        QMetaObject.connectSlotsByName(TestExternalDisplayWindow)
    # setupUi

    def retranslateUi(self, TestExternalDisplayWindow):
        TestExternalDisplayWindow.setWindowTitle(QCoreApplication.translate("TestExternalDisplayWindow", u"Test_ExternalDisplay", None))
        self.groupBox.setTitle(QCoreApplication.translate("TestExternalDisplayWindow", u"\u0422\u0435\u0441\u0442 \u0440\u0430\u0437\u0434\u0435\u043b\u0435\u043d\u0438\u044f \u0434\u0438\u0441\u043f\u043b\u0435\u0435\u0432:", None))
        self.pushButton_success.setText(QCoreApplication.translate("TestExternalDisplayWindow", u"\u0423\u0441\u043f\u0435\u0445", None))
        self.pushButton_fail.setText(QCoreApplication.translate("TestExternalDisplayWindow", u"\u041e\u0448\u0438\u0431\u043a\u0430", None))
        self.pushButton_all_test_break.setText(QCoreApplication.translate("TestExternalDisplayWindow", u"\u041f\u0440\u0435\u0440\u0432\u0430\u0442\u044c \u0442\u0435\u0441\u0442\u044b", None))
    # retranslateUi
